...
def parse_command_line():
    ...
    parser.add_argument('-et', '--ensemble_type', type=int, default=1, help='Ensemble type (1: random weights + data shuffle, 2: data bootstrap + all from 1, 3: data noise + all from 2)')
